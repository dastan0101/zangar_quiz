  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar">
	  		...
	  		<h1><a href="/admin/dashboard" class="logo">Zangar-M</a></h1>
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li class="active">
            <a href="/admin/review-exams"><span class="fa fa-file-text-o mr-3"></span> Exams Review</a>
          </li>
